...
class App{
    ...
    getCountriStatusAll(name,data){
        ...
        chart.src = "https://image-charts.com/chart?cht=pd&chd=a:"+p+","+data.recovered.value+","+data.deaths.value+"&chs=500x500&chdl="+str.p+"|"+str.s+"|"+str.m+"&chli="+data.confirmed.value+"&chco=f79b45|5fff14|f70000&chl="+p+"|"+data.recovered.value+"|"+data.deaths.value
